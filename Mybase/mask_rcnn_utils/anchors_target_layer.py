...
class AnchorsTargetLayer(object):
    ...
    def generate_rpn_loss(self, rpn_prbs_pst=None, rpn_prds_pst=None, gbxs=None, gbx_nums=None):
        ...
        rpn_prbs_los = tf.cond(fbg_num>0, lambda: rpn_prbs_los/fbg_num, lambda: tf.constant(0.0))
        rpn_prds_los = tf.cond(fbg_num>0, lambda: rpn_prds_los/fbg_num, lambda: tf.constant(0.0))
